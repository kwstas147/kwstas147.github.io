#!/usr/bin/env python3
"""
Script για αυτόματη βελτιστοποίηση εικόνων για το 3D Printing Gallery

Χρήση:
    python optimize_images.py input-folder output-folder

Παράδειγμα:
    python optimize_images.py C:\Photos\3DPrints assets\images\3d-printing
"""
...
def main():
    if len(sys.argv) < 3:
        ...
        print("\nΠαράδειγμα:")
        print("  python optimize_images.py C:\\Photos\\3DPrints assets\\images\\3d-printing")
        sys.exit(1)
