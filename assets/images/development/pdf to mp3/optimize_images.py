#!/usr/bin/env python3
"""
Script για αυτόματη βελτιστοποίηση εικόνων για Portfolio Gallery

Χρήση:
    python optimize_images.py input-folder output-folder

Παράδειγμα:
    python optimize_images.py C:\Documents\development assets\images\development
"""
...
def main():
    if len(sys.argv) < 3:
        ...
        print("\nΠαράδειγμα:")
        print("  python optimize_images.py C:\\Documents\\development assets\\images\\development")
        sys.exit(1)
