...
const translations = {
    el: {
        ...
        aboutInterests: "Προσωπικά Ενδιαφέροντα",
        aboutInterestsFitnessTitle: "Γυμναστική",
        aboutInterestsFitness: "Γυμναστήριο, τρέξιμο, πεζοπορία",
        aboutInterestsFamilyTitle: "Οικογένεια",
        aboutInterestsFamily: "2 παιδιά",
    ...
    en: {
        ...
        aboutInterests: "Personal Interests",
        aboutInterestsFitnessTitle: "Fitness",
        aboutInterestsFitness: "Gym, running, hiking",
        aboutInterestsFamilyTitle: "Family",
        aboutInterestsFamily: "2 children",
