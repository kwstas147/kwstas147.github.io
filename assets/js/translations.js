...
const translations = {
    el: {
        ...
        "pages.programming.projects.easySlot.description": "Μια ολοκληρωμένη B2B & B2C πλατφόρμα διαχείρισης ραντεβού και κρατήσεων τύπου SaaS. Υποστηρίζει πολλαπλές επιχειρήσεις, διαθέτει ισχυρό Admin Panel και αξιοποιεί την υποδομή του Firebase για cloud συγχρονισμό σε πραγματικό χρόνο. Ενσωματώνει έξυπνο σύστημα ειδοποιήσεων, QR code check-ins, εσωτερικό chat, και δυναμικό ημερολόγιο αποφεύγοντας επικαλύψεις. Σχεδιασμένη με Clean Architecture, εξασφαλίζει απόλυτη σταθερότητα και κορυφαία εμπειρία χρήστη, ενώ προσφέρει άμεση παραγωγή αναφορών σε PDF/Excel.",
        "pages.programming.projects.myPlan.title": "MyPlan",
        "pages.programming.projects.myPlan.description": "Κορυφαία εφαρμογή σχεδιασμού υγείας και ευεξίας που επαναπροσδιορίζει την παρακολούθηση της φυσικής κατάστασης. Μέσω της άμεσης ενσωμάτωσης με το Health Connect, αντλεί αυτόματα και με ασφάλεια βιομετρικά δεδομένα. Διαθέτει premium Edge-to-Edge Cupertino σχεδιασμό, εξατομικευμένα πλάνα γευμάτων και ασκήσεων, καθώς και λεπτομερή καταγραφή μετρήσεων. Αναπτύχθηκε με την αρχιτεκτονική Riverpod, παρέχοντας αστραπιαία πλοήγηση και αισθητική υπεροχή.",
        "pages.programming.projects.synapses.title": "Synapses",
        "pages.programming.projects.synapses.description": "Προηγμένη εφαρμογή ελέγχου και διαχείρισης IoT συσκευών τεχνολογίας Bluetooth Low Energy (BLE). Σχεδιασμένη με αυστηρά βιομηχανικά πρότυπα, επιτρέπει τη διαχείριση προφίλ συσκευών, ζωντανή παρακολούθηση δεδομένων, και εκτέλεση Over-The-Air (OTA) αναβαθμίσεων λογισμικού (firmware). Ενσωματώνει μηχανισμούς ασφαλείας, κρυπτογραφημένη αποθήκευση και λεπτομερή καταγραφή ρυθμίσεων (config logging), προσφέροντας απόλυτο έλεγχο μέσα από ένα σύγχρονο και φιλικό περιβάλλον.",
        "pages.programming.projects.synthesis.title": "Synthesis",
        "pages.programming.projects.synthesis.description": "Ένα πρωτοποριακό εργαλείο διαχείρισης εργαστηριακών μιγμάτων, δομικών υλικών και αναφορών, ενισχυμένο με τη δύναμη της τεχνητής νοημοσύνης. Χρησιμοποιεί το Google Gemini AI για ανάλυση και βελτιστοποίηση των αναλογιών, υποστηρίζει μαζική σάρωση (batch scanning) και δημιουργεί άμεσα επαγγελματικές αναφορές (PDF/Excel). Η εμπειρία ολοκληρώνεται με διαδραστικά γραφήματα, έξυπνες ειδοποιήσεις και home screen widgets, αποτελώντας τον απόλυτο σύμμαχο στην εργαστηριακή έρευνα.",
    ...
    en: {
        ...
        "pages.programming.projects.smartSetup.title": "Smart Setup",
        "pages.programming.projects.easySlot.title": "EasySlot",
        "pages.programming.projects.easySlot.description": "A comprehensive B2B & B2C appointment booking and slot management SaaS platform. Supporting multi-business environments, it features a robust Admin Panel and leverages Firebase infrastructure for real-time cloud synchronization. It integrates smart notifications, QR code check-ins, internal chat, and dynamic conflict-free calendars. Engineered with Clean Architecture, it guarantees absolute stability and a premium user experience, while offering instant PDF/Excel report generation.",
        "pages.programming.projects.myPlan.title": "MyPlan",
        "pages.programming.projects.myPlan.description": "A top-tier health and wellness planning application that redefines fitness tracking. Through seamless integration with Health Connect, it securely and automatically retrieves biometric data. It boasts a premium Edge-to-Edge Cupertino design, personalized meal and workout plans, and detailed body measurements logging. Built using Riverpod state management, it delivers lightning-fast navigation and aesthetic superiority.",
        "pages.programming.projects.synapses.title": "Synapses",
        "pages.programming.projects.synapses.description": "An advanced IoT device control and management application utilizing Bluetooth Low Energy (BLE) technology. Designed to strict industrial standards, it enables device profile management, live data monitoring, and Over-The-Air (OTA) firmware updates. It integrates robust security mechanisms, encrypted storage, and detailed configuration logging, offering complete control through a modern and intuitive interface.",
        "pages.programming.projects.synthesis.title": "Synthesis",
        "pages.programming.projects.synthesis.description": "An innovative laboratory mixture, construction material, and report management tool, empowered by artificial intelligence. It utilizes Google Gemini AI to analyze and optimize proportions, supports batch scanning, and instantly generates professional reports (PDF/Excel). The experience is completed with interactive charts, smart notifications, and home screen widgets, making it the ultimate ally in laboratory research and quality control.",
        "pages.programming.projects.duplicateFinder.title": "DuplicateFinder",
